...
Our `SpinLock` isn't going to outperform the standard library Mutex - but it's close. Here's some test code to compare the two. (The standard library mutex is very fast, and includes platform specific enhancements sometimes.)
